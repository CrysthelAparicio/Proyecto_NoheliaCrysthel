...
public class Lista {
    ...
    public void insertarPorReferencia(Object referencia, Object valor) {
        ...
        if (!esVacia()) {
            ...
            if (buscar(referencia)) {
                ...
                while (k) {
                    if (aux.getValor().equals(referencia)) {
                        k = false;
                    } else {
                        aux = aux.getSiguiente();
    ...
    public int getPosicion(Object referencia) throws Exception {
        ...
        if (buscar(referencia)) {
            ...
            while (((Usuario) referencia) != aux.getValor()) {
    ...
    public void removerPorReferencia(Object referencia) {
        ...
        if (buscar(referencia)) {
            ...
            if (inicio.getValor() == ((Usuario) referencia)) {
                ...
                // Recorre la lista hasta llegar al nodo anterior 
                // al de referencia.
                while (aux.getSiguiente().getValor() != ((Usuario) referencia)) {
                    aux = aux.getSiguiente();
                }
